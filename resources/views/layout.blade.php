        ...
        <div class="container px-0">
            ...
            <div class="ms-auto d-flex align-items-center order-lg-3">
                <div class="d-flex gap-2 align-items-center">
                    ...
                    @guest
                    <a href="{{ route('login.form') }}" class="btn btn-outline-dark btn-sm  ">
                        ...
                        Connexion</a>
                    <a href="{{ route('register.form') }}" class="btn btn-dark d-none d-md-block btn-sm"> <svg
                    ...
                    @else
                    <a href="{{ route('dashboards') }}" class="btn btn-outline-dark btn-sm ">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                            class="bi bi-box-arrow-in-right" viewBox="0 0 16 16">
                            <path fill-rule="evenodd"
                                d="M6 3.5a.5.5 0 0 1 .5-.5h8a.5.5 0 0 1 .5.5v9a.5.5 0 0 1-.5.5h-8a.5.5 0 0 1-.5-.5v-2a.5.5 0 0 0-1 0v2A1.5 1.5 0 0 0 6.5 14h8a1.5 1.5 0 0 0 1.5-1.5v-9A1.5 1.5 0 0 0 14.5 2h-8A1.5 1.5 0 0 0 5 3.5v2a.5.5 0 0 0 1 0z">
                ...
                <div class="d-flex align-items-center">
                    <div class="dropdown">
                        <a href="{{route('dashboards')}}"
                            ...
                            <i class="bi bi-person"></i> <!-- Remplace l'icône du soleil par celle de l'utilisateur -->
