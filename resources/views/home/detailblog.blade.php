            ...
            <div class="row">
                <div class="col-lg-12 col-md-12 col-12">
                    ...
                    <div class="d-flex flex-column flex-lg-row gap-2 align-items-lg-center justify-content-between mb-2">
                        <div>
                            <h1 class="mb-0 h2 fw-bold">Detail de l'evenement </h1>
                        </div>
                ...
                <div class="col-xl-6 col-12">
                    <div class="d-flex flex-column gap-4">
                            ...
                            <div class="card-body border-top py-3">
                                <div class="d-flex justify-content-between align-items-center">
                                    <div class="d-flex align-items-center flex-row gap-2">
                                        ...
                                        <div class="">
                                            <h5 class="mb-0 text-body">Date fin </h5>
                                        </div>
                                    </div>
                                    <div>
                                        <div>
                                            <p class="text-dark mb-0 fw-semibold">{{ $detailblog->date_event_fin }}</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        16">
                                    ...
                                    <div>
                                        <div>
                                            <p class="text-dark mb-0 fw-semibold">30 Minute</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <h4 class="mb-3">Nombre de participants</h4>
                                <!-- progress bar -->
