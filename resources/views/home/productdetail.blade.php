                        ...
                        <div class="row gy-4">
                            ...
                            <div class="col-12">
                                <div>
                                    ...
                                    <a :href="`/s3/${product.images[selectedImage].imagename}`" class="glightbox" data-gallery="gallery1">
                ...
                <div class="card shadow-sm">
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            ...
                            <p class="small text-muted">Profitez de notre service de livraison partout dans le monde à des prix abordables. <a href="#" class="text-decoration-underline">Découvrez nos tarifs</a></p>
                        </div>
                        ...
                        <div class="mb-3">
                            <div class="d-flex align-items-start">
                                ...
                                <div>
                                    ...
                                    <p class="small text-muted mb-0">Nos frais de livraison sont abordables et nous offrons même la livraison gratuite pour des achats supérieurs à un certain montant.</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="mb-3">
                            <div class="d-flex align-items-start">
                                ...
                                <div>
                                    ...
                                    <p class="small text-muted">Retours gratuits sous 10 jours. Achetez en toute confiance !</p>
                                </div>
                            </div>
                        </div>
                    </div>
