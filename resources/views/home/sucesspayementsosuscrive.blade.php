@extends('layout')
@section('content', 'Paiement Validé')
@section('content')
    ...
    <div class="d-flex justify-content-center align-items-center" style="height: 100vh; background-color: #f4f7fa;">
        <div class="text-center">
            ...
            <h1 class="display-4 fw-bold" style="color: #28a745;">Souscription effectuée avec succès</h1>
            <p class="lead" style="font-size: 1.25rem; color: #6c757d;">
                Votre souscription a été effectuée avec succès. Vous recevrez les détails de votre facture par email et nous
                activons dès à présent votre publicité.
            </p>
            <div>
