    ...
    <div class="container-fluid px-0">
      ...
      <div class="order-lg-3">
        <div class="d-flex align-items-center">
          ...
          <a href="../../pages/sign-in.html" class="btn btn-outline-primary ms-2 d-none d-lg-block">Sign in</a>
        ...
        <ul class="navbar-nav mx-auto">
          ...
          <li class="nav-item dropdown">
            ...
            <ul class="dropdown-menu dropdown-menu-arrow" aria-labelledby="navbarPages">
              ...
              <li class="dropdown-submenu dropend">
                <a class="dropdown-item dropdown-list-group-item dropdown-toggle" href="#">Mentor</a>
                <ul class="dropdown-menu">
                  <li>
                ...
                <a class="list-group-item list-group-item-action border-0" href="../../docs/changelog.html">
                  <div class="d-flex align-items-center">
                    ...
                    <div class="ms-3">
                      <h5 class="mb-0">
                        Changelog
                        <span class="text-primary ms-1" id="changelog">v3.3.1</span>
                      </h5>
